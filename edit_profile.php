				...
				<tr>
					...
					<td> 
			           <select class="form-control" name="Relationship">
			           	 ...
			           	 <option>I'ts Complecated</option>			           	
		                </select>
					</td>
				</tr>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<form action="recovery.php?id=<?php echo $user_id; ?>" method="post" id="f">
											...
											<pre>Ans the que if you forgotten<br>password</pre><br><br>
										</form>
										<?php
...
<?php
  ...
  if(isset($_POST['update']))
  {
  	...
  	$update = "update users set f_name='$f_name', l_name='$l_name', user_name='$u_name', describe_user= '$describe_user', Relationship='$Relationship', user_pass='$u_pass', user_email='$u_email', user_country='$u_country', user_gender='$u_gender', user_birthday='$u_birthday' where user_id='$user_id'";
    ...
    $run = mysqli_query($con, $update);
  	...
  	if($run)
	{
      echo "<script>alert('Your Profile is updateed..')</script>";
	  echo "<script>window.open('edit_profile.php?u_id$user_id', '_self')</script>";
